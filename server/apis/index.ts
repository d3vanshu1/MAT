...
const apis = {
  ...
  // MAST v2 pipeline
  MastRunPipeline, MastResetPipeline, MastPurgeRun, MastDiagRetrievalProbe, MastDiagSweepProbe, MastDiagLabelProbe, MastDiagSweepPromptAB, MastPublish,
  // DB setup
